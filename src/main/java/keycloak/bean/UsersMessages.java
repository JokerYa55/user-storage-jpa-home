...
public class UsersMessages implements Serializable {
    ...
    public UsersMessages(Long id) {
        this.id = id;
    }

    public UsersMessages(Long id, Date dateCode, boolean status) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UsersMessages)) {
            return false;
        }
        UsersMessages other = (UsersMessages) object;
